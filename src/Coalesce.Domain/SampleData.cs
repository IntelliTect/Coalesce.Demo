        ...
        public static void Initialize(AppDbContext context, int randomSeed = 1)
        {
            ...
            lock (_lock)
            {
                ...
                if (!context.Companies.Any())
                {
                    ...
                    List<Company> companies = GenFu.GenFu.ListOf<Company>(10);
                ...
                if (!context.Cases.Any())
                {
                    ...
                    List<Case> cases = GenFu.GenFu.ListOf<Case>(20);
                    ...
                    cases.ForEach(c =>
                    {
                        ...
                        string phrase = titlePhrases[random.Next(0, titlePhrases.Length)];
                        string productName = c.CaseProducts.First().Product.Name;
